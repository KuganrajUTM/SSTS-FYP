...
<div class="sos-container">
    <div class="container">
        <h1 class="text-center mb-4" style="color: var(--navy); font-weight: 800; font-size: 2rem;">
            <i class="fas fa-exclamation-triangle me-2" style="color:var(--danger);"></i> SOS Messages
        </h1>
        ...
        <div class="sos-card">
            <div class="sos-header">
                <i class="fas fa-headphones me-2"></i> Emergency Messages from Your Driver ({{ $messages->count() }})
            </div>
            <div class="p-4">
                @forelse($messages as $msg)
                    <div class="sos-item">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                            ...
                            <form action="{{ route('parent.sos.destroy', $msg->id) }}" method="POST" onsubmit="return confirm('Delete this SOS message?')">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                    <div class="no-data">
                        ...
                        No SOS messages from your driver.
                    </div>
                @endforelse
            </div>
        </div>
